    ...
    },
    {
      ...
      value: function drawO(i, r, s) {
        ...
        ctx.arc(
          i,
          r,
          smaller(canvas.height, canvas.width) / 8,
          0,
          Math.PI * 2,
          true
        );
...
function ticIt(arr, obj, num1, num2) {
  if (
    (arr[obj.n1].num === num1 && arr[obj.n2].num === num2) ||
    (arr[obj.n1].num === num2 && arr[obj.n2].num === num1)
  )
    return true;
  return false;
}
function tictac() {
  ...
  if (tacIt(r1)) {
    ...
    var _o = tacIt(r2);
    if (ticIt(r2, _o, 4, 5)) new Draw().o(6);
    else if (ticIt(r2, _o, 4, 6)) new Draw().o(5);
    else if (ticIt(r2, _o, 5, 6)) new Draw().o(4);
  } else if (tacIt(r3)) {
    var _o2 = tacIt(r3);
    if (ticIt(r3, _o2, 7, 8)) new Draw().o(9);
    else if (ticIt(r3, _o2, 7, 9)) new Draw().o(8);
    else if (ticIt(r3, _o2, 8, 9)) new Draw().o(7);
  } else if (tacIt(r4)) {
    var _o3 = tacIt(r4);
    if (ticIt(r4, _o3, 1, 4)) new Draw().o(7);
    else if (ticIt(r4, _o3, 1, 7)) new Draw().o(4);
    else if (ticIt(r4, _o3, 4, 7)) new Draw().o(1);
  } else if (tacIt(r5)) {
    var _o4 = tacIt(r5);
    if (ticIt(r5, _o4, 2, 5)) new Draw().o(8);
    else if (ticIt(r5, _o4, 2, 8)) new Draw().o(5);
    else if (ticIt(r5, _o4, 5, 8)) new Draw().o(2);
  } else if (tacIt(r6)) {
    var _o5 = tacIt(r6);
    if (ticIt(r6, _o5, 3, 6)) new Draw().o(9);
    else if (ticIt(r6, _o5, 3, 9)) new Draw().o(6);
    else if (ticIt(r6, _o5, 6, 9)) new Draw().o(3);
  } else if (tacIt(r7)) {
    var _o6 = tacIt(r7);
    if (ticIt(r7, _o6, 1, 5)) new Draw().o(9);
    else if (ticIt(r7, _o6, 1, 9)) new Draw().o(5);
    else if (ticIt(r7, _o6, 5, 9)) new Draw().o(1);
  } else if (tacIt(r8)) {
    var _o7 = tacIt(r8);
    if (ticIt(r8, _o7, 3, 5)) new Draw().o(7);
    else if (ticIt(r8, _o7, 3, 7)) new Draw().o(5);
    else if (ticIt(r8, _o7, 5, 7)) new Draw().o(3);
  } else {
